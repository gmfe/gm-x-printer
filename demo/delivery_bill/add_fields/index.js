...
const commonFields = {
  [i18next.t('基础')]: [
    ...
    {
      key: i18next.t('下单总数(销售单位)'),
      value: i18next.t('{{下单总数_销售单位}}')
    },
    {
      key: i18next.t('出库总数(销售单位)'),
      value: i18next.t('{{出库总数_销售单位}}')
    },
...
const tableFields = {
  [i18next.t('基础')]: [
    ...
    {
      key: i18next.t('商品名（不带*号）'),
      value: i18next.t('{{列.商品名_无星号}}')
    },
  ...
  [i18next.t('价格')]: [
    {
      ...
      value: i18next.t('{{列.不含税单价_基本单位}}')
    },
    {
      key: i18next.t('不含税单价(销售单位)'),
      value: i18next.t('{{列.不含税单价_销售单位}}')
    },
    {
    ...
    },
    {
      ...
      value: i18next.t('{{列.单价_销售单位}}')
    },
    {
      key: i18next.t('原单价(基本单位)'),
      value: i18next.t('{{列.原单价_基本单位}}')
    },
    {
      key: i18next.t('原单价(销售单位)'),
      value: i18next.t('{{列.原单价_销售单位}}')
    }
  ],
  [i18next.t('数量')]: [
    {
      key: i18next.t('下单数'),
      value: i18next.t('{{列.下单数}}{{列.销售单位}}')
    },
    {
      key: i18next.t('出库数(基本单位)'),
      value: i18next.t('{{列.出库数_基本单位}}{{列.基本单位}}')
    },
    {
      key: i18next.t('出库数(销售单位)'),
      value: i18next.t('{{列.出库数_销售单位}}{{列.销售单位}}')
    }
  ],
  [i18next.t('金额')]: [
